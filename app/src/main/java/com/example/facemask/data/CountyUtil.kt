...
object CountyUtil {
    ...
    fun getTownsByCountyName(countyName: String): List<Any> {
        val index = counties.indexOf(countyName)    //String.indexOf回傳該字串在該鎮列的第幾元素
        return towns[index]
    }
     ...
     * @param 要傳入的城市
     */
    fun getCountyIndexByName(country: String): Int {
        return counties.indexOf(country)
    }

    fun getTownIndexByName(countryname : String,town: String): Int {
